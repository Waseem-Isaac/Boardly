import{F as q,G as J,H as W,f as Q,t as U,w as Y}from"./chunk-6ZYP5YLI.js";import{i as G,j as K,s as v}from"./chunk-7N7YJUU7.js";import{Cb as R,Db as I,Fb as k,Gb as A,Hb as M,Jb as P,Kb as N,Lb as j,Oa as d,Rb as _,Tb as z,V as p,Vb as L,X as c,Z as a,ab as u,bb as h,d as m,hc as F,jb as V,ka as E,nb as O,ob as b,pa as T,pb as f,qc as H,sc as B,tb as g,ua as S,ub as y,vb as w,wb as x}from"./chunk-EOK4J5D5.js";var X=(()=>{class o{_animationsDisabled=Q();state="unchecked";disabled=!1;appearance="full";constructor(){}static \u0275fac=function(i){return new(i||o)};static \u0275cmp=u({type:o,selectors:[["mat-pseudo-checkbox"]],hostAttrs:[1,"mat-pseudo-checkbox"],hostVars:12,hostBindings:function(i,n){i&2&&_("mat-pseudo-checkbox-indeterminate",n.state==="indeterminate")("mat-pseudo-checkbox-checked",n.state==="checked")("mat-pseudo-checkbox-disabled",n.disabled)("mat-pseudo-checkbox-minimal",n.appearance==="minimal")("mat-pseudo-checkbox-full",n.appearance==="full")("_mat-animation-noopable",n._animationsDisabled)},inputs:{state:"state",disabled:"disabled",appearance:"appearance"},decls:0,vars:0,template:function(i,n){},styles:[`.mat-pseudo-checkbox {
  border-radius: 2px;
  cursor: pointer;
